...
- [flerp](https://crates.io/crates/flerp) - A terminal UI for exploring and analyzing text files, PDFs, and images with live search, keyword extraction, and multiple themes.
