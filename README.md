...
- [oracle](https://github.com/yashksaini-coder/oracle) - A TUI rust codebase inspector to get the direct look to the objects, functions, structs, Impl, mods and crates API info directly in terminal
