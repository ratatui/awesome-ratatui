...
- [agent-console](https://github.com/buhuipao/agent-console) - A local dashboard for Codex and Claude Code sessions, with per-session status, cross-session alerts, and persistent same-workspace shells.
